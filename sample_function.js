...
/* ALL variables passed to this object are set as part of this
 * object, not a global object. Always use `this` to acccess them.
 * For example, DO NOT use Flow, but this.Flow.
 */
...
parameters: function() {
	...
	return [["param1", "0 to 100"],
                ["param2", "-5 to -1", 0, "Description for param2 is here", 5]];
},
